...
export function UrbanCanyonStatus({ frame, isPresentationMode }: UrbanCanyonStatusProps) {
  ...
  const gnssStatusColor = frame.gnssReliable ? '#059669' : degraded ? '#D97706' : recovering ? '#7C3AED' : '#059669';
  const gnssStatusBg = frame.gnssReliable ? '#ECFDF5' : degraded ? '#FFFBEB' : recovering ? '#F5F3FF' : '#ECFDF5';
    ...
    <View style={[styles.liveCard, degraded && styles.liveCardDegraded, recovering && styles.liveCardRecovery]}>
      ...
      <View style={styles.sensorsRow}>
        ...
        <View style={styles.sensorItem}>
          ...
          <Text style={[styles.sensorVal, { color: '#7C3AED' }]}>
      ...
      <View style={styles.compareBox}>
        ...
        <ErrorBar label="GNSS" meters={frame.gnssPositionErrorM} maxMeters={28} color="#4F46E5" />
        <ErrorBar label="NAVIS" meters={frame.navisPositionErrorM} maxMeters={28} color="#10B981" />
      </View>
